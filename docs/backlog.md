...
**Приёмка:** разрешено для прошлых дат; меняются ciphertext/iv/sticker и `updated_at`; звезда не начисляется; ownership обязателен.
...
### PH-401 · P0 · Mascot/sticker catalog seeds

**Приёмка:** 4–6 маскотов и набор стикеров имеют стабильные code; один бесплатный starter; seed idempotent; asset paths существуют в frontend image.

### PH-402 · P0 · Пороговые разблокировки

**Приёмка:** пороги 10/30/100 проверяются после создания записи в той же транзакции; повторная проверка idempotent; ответ create содержит newly unlocked.
